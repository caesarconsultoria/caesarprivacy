                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse menu-dropdown" id="sidebarCRM">
                                            <ul class="nav nav-sm flex-column">
                                                ...
                                                <li class="nav-item">
                                                  <!--  <a href="${pageContext.request.contextPath}/WEB-INF/views/apps-crm-companies.jsp" class="nav-link" data-key="t-companies"> Companies </a> -->
                                                        <a href="${pageContext.request.contextPath}/companies" class="nav-link" data-key="t-companies"> Companies </a>
                                                </li>
                                                <li class="nav-item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Design & Develop by CÆSAR Cosultoria
                            </div>
                        </div>
                    </div>
                </div>

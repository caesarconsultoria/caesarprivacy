...
public class OperadorResource {
	...
	/**
	 * Método utilizado para atualizar um Operador a partir do seu Id
	 * @param operadorDto
	 * @return
	 */
	@PutMapping("/{id}")
	public ResponseEntity<Void> update(@Valid @RequestBody OperadorDTO operadorDto){
		//DataGovernanceEntities obj = operadorService.fromDTO( operadorDto );
		obj = operadorService.update( operadorDto );
